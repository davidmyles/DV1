...
class UnknownImageTest {
    ...
    void unknownImageWeightsTest() throws IOException, SQLException {
        UnknownImage ui = new UnknownImage();
        double [] d1 = ui.unknownImageInput("/Users/davidjmyles/IdeaProjects/DV1/trainingimages3/img_01.png",x,y);
        double [] d2 = ui.retrieveAvgValues();
        double [] d3 = ui.applyAvgUnkown(d1,d2);
        Array2DRowRealMatrix r1 = ui.retrievePrincipleComponentsx4();
        ui.createPCMatrix(81);
    ...
    void matchImageTest() throws SQLException, IOException {
        ...
        double [] p1 = ui.unknownImageInput("/Users/davidjmyles/IdeaProjects/DV1/trainingimages3/img_01.png",3,3);
        double [] p2 = ui.retrieveAvgValues();
        double [] p3 = ui.applyAvgUnkown(p1,p2);
        Array2DRowRealMatrix rm = ui.retrievePrincipleComponentsx4();
        Array2DRowRealMatrix rm2 = ui.createPCMatrix(81);
        ui.unknownImageWeightsPC(p3,rm,rm2,0);
        ui.unknownImageWeightsPC(p3,rm,rm2,1);
        ...
        String matchActual = ls.matchImage4Vectors();
        String matchExpected = "1";
